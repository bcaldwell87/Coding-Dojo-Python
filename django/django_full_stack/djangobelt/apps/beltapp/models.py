...
class Wish(models.Model):
    ...
    seeker = models.ManyToManyField(User, related_name="favorite_jobs")
    uploader = models.ForeignKey(User, related_name="uploaded_jobs", null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
